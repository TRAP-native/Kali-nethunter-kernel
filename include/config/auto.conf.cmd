...
ifneq "$(srctree)" "/home/anonymous/Downloads/android_kernel_sony_sm8250_pdx206-q"
include/config/auto.conf: FORCE
endif
ifneq "$(CC)" "clang"
include/config/auto.conf: FORCE
endif
ifneq "$(LD)" "/home/anonymous/android/toolchains/aarch64-4.9/bin/aarch64-linux-android-ld"
include/config/auto.conf: FORCE
endif
ifneq "$(CLANG_FLAGS)" " --target=aarch64-linux-gnu --prefix=/home/anonymous/android/toolchains/aarch64-4.9/bin/ --gcc-toolchain=/home/anonymous/android/toolchains/aarch64-4.9 -no-integrated-as -Werror=unknown-warning-option"
include/config/auto.conf: FORCE
endif
ifneq "$(SRCARCH)" "arm64"
include/config/auto.conf: FORCE
